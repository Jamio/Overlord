...

{
	...
	_unit addEventHandler ["Killed", { 
		...
		if ( !(alive neaville_aa_5) && !(alive neaville_aa_6) ) then {

			["main_obj_4","SUCCEEDED"] call BIS_fnc_taskSetState;
			missionProfileNamespace setVariable ["main_obj_4","SUCCEEDED"];
...
} forEach [neaville_aa_5,neaville_aa_6];