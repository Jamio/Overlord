...
[
	...
	"Ready to Defend Neaville",										// Title of the action
	...
	"(_this == company_commander) && (OL_mission_1_ended) && !(OL_mission_started_2)",						// Condition for the action to be shown
	"(_caller == company_commander) && (OL_mission_1_ended) && !(OL_mission_started_2)",						// Condition for the action to progress
	{},													// Code executed when action starts
	{},													// Code executed on every progress tick
	{ 


		OL_mission_started_2 = true;
		publicVariable 'OL_mission_started_2';
				
		
		[[],OL_start_mission_2] remoteExec ["spawn",2];
